...
class AppConfig():
    ...
    def add_blueprints(self):
        ...
        from blueprints.authentication_blueprint.auth import auth_blueprint
        self.app.register_blueprint(auth_blueprint)
        from blueprints.recepies_blueprint.recepies import recepies_blueprint
        self.app.register_blueprint(recepies_blueprint)
        from blueprints.contact_blueprint.contact import contact_blueprint
        self.app.register_blueprint(contact_blueprint)
        from blueprints.about_blueprint.about import about_blueprint
        self.app.register_blueprint(about_blueprint)

        from blueprints.blog_blueprint.blog import blog_blueprint
